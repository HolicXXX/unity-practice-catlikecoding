...
namespace CustomMesh
{
    ...
    public class MeshRoundedCube : MonoBehaviour
    {
        ...
        void CreateVertices()
        {
            ...
            half = new Vector3(xSize / 2f, ySize / 2f, zSize / 2f);
        ...
        void SetVertex(int i, int x, int y, int z)
        {
            ...
            vertices[i] = inner + normals[i] * roundness - half;
